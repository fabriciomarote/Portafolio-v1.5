    ...
    return (
        <>
            ...
            <div className='about-container' data-theme={theme}>
                <div className='title-box span1 wow animate__animated animate__zoomIn animate__delay-1s'>
                    <p>SOBRE MÍ</p>
                </div> 
                <div className='box-image wow animate__animated animate__flipInY animate__delay-1s'>
                    <img className='foto' src={foto} alt="logo" />
                </div> 
                <div className='text-box span1 wow animate__animated animate__zoomIn'>    
