            ...
            <div className='about-container' data-theme={theme}>
                ...
                <div className='body-about'>
                    ...
                    <div className='text-box span1 wow animate__animated animate__zoomIn animate__delay-0.5s'>    
                        ...
                        <p>He desarrollado varios proyectos utilizando diferentes lenguajes y tecnologías, tengo experiencia y un buen manejo en lo que respecta al trabajo en equipo ya que vengo de hace años realizando proyectos grupales, tambien tengo conocimientos sobre las metodologías ágiles (SCRUM).</p>
